...
const Checkerboard = () => {
    ...
    return (
        <div className="relative flex flex-col items-center gap-8 p-6 bg-[#0c0a09] min-h-screen text-stone-100 font-serif overflow-hidden">
            {/* Subtle background accents similar to HomePage */}
            ...
            <div className="z-10 flex flex-col items-center">
                ...
                <div className="flex items-center">
                    ...
                    <div className="p-4 bg-[#3e2723] rounded-[2rem] shadow-[0_40px_80px_-15px_rgba(0,0,0,0.8)] border-8 border-[#2b1b19] animate-in slide-in-from-bottom-8 duration-700">
